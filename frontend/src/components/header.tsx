                            ...
                            {navLinks.map((link, i) => (
                                <div key={link.label} className="flex items-center">
                                    <Link
                                        ...
                                        style={{
                                            fontFamily: "Georgia, serif",
                                            color: location.pathname === link.path ? "#C9A84C" : "#C9A84C",
                                    ...
                                    >
                                        ...
                                        <span className="relative z-10 group-hover:text-[#e8c76a] transition-colors duration-200">
                                            {link.label}
                                        </span>
                                    </Link>

                                    {i < navLinks.length - 1 && <FloralSeparator />}
                                </div>
                            ))}
                        </nav>
                    ...
                    <nav className="flex-1 px-6 py-4 flex flex-col gap-1">
                        {navLinks.map((link) => (
                            ...
                            >
                                <span
                                    style={{
                                        color: location.pathname === link.path ? "#C9A84C" : "#5a3a2a",
                                        fontSize: "0.6rem",
                                    }}
                                >
                                    ◆
